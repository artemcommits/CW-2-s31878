...
class Program
{
    static void Main()
    {
        ...
        Container fridge = new RefrigeratedContainer(300, 500, 900, 4000, "Fish");
        ...
        Ship ship1 = new Ship("White Pearl", 60, 10, 11300);
        ...
        Container fridge1 = new RefrigeratedContainer(300, 500, 900, 4000, "Bananas");

        liquidSafe1.Load(1800);
        liquidDanger1.Load(900);
        gasContainer1.Load(4000);
        fridge1.Load(2500);

        ship1.LoadContainer(liquidSafe);
        ship1.LoadContainer(liquidDanger);
